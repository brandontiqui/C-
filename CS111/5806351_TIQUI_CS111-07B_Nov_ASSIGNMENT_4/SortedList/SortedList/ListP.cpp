...
void List::insertSorted(int& i, int index, const ListItemType& newItem)
	throw(ListIndexOutOfRangeException, ListException)
// --------------------------------------------------------------------------
// Preconditions: i is set to a value of 0, index is set to a value of 1,
//                and newItem is set to a ListItemType object.
// Postconditions: newItem is inserted in an ordered position in the list.
// --------------------------------------------------------------------------
{
...
int List::retrieveSorted(int& index, const ListItemType& dataItem) const
	throw(ListIndexOutOfRangeException)
// --------------------------------------------------------------------------
// Preconditions: index is set to a value of 1 and dataItem is set to a 
//                ListItemType object
// Postconditions: An integer representing a value's position in the list is
//                 returned.  -1 is returned if the value is not in the list.
// --------------------------------------------------------------------------
{
	ListNode *cur = find(index);
